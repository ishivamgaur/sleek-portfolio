...
export function ExperienceItem({
  ...
  // Use defaultExpanded if provided, otherwise default expand only the first item
...
// Devicon CDN — has every tech icon. Slug map converts display names to devicon folder names.
const DEVICON_BASE =
...
const getIconUrl = (name: string) => {
  ...
  // fallback: try the name directly as a devicon slug
