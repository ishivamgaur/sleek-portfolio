...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden pb-4">
      {/* Banner */}
      <div
        className={`h-48 md:h-64 w-full relative transition-colors duration-500 ${bannerError ? "bg-gradient-to-b from-slate-800 to-black" : !settingsReady || bannerLoading ? "" : "bg-muted/30"}`}
      >
        {(!settingsReady || bannerLoading) && !bannerError && (
