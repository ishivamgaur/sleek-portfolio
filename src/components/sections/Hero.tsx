...
import { Gift, X, Play, Pause, Download } from "lucide-react";
...
export default function Hero() {
  ...
  const downloadLink = resumeUrl
    ? resumeUrl.includes("/upload/")
  ...
  return (
    <section className="relative w-full overflow-hidden pb-0">
      {/* Banner */}
      <div className="h-38 md:h-52 w-full relative bg-muted/30">
        <Image
          src={bannerImage}
          alt="Banner"
          fill
      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex justify-between items-start -mt-12 md:-mt-16 mb-4 relative z-10">
          ...
          <div className="pt-16 md:pt-20 flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a
                    ...
                    className="w-7 h-7 sm:w-8 sm:h-8 rounded-md border border-dashed border-border bg-secondary/5 hover:bg-muted/50 transition-all flex items-center justify-center text-foreground/80 hover:text-foreground shrink-0 cursor-pointer"
                  >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a
                      ...
                      className="w-7 h-7 sm:w-8 sm:h-8 rounded-md border border-dashed border-border bg-secondary/5 hover:bg-muted/50 transition-colors text-foreground/80 hover:text-foreground flex items-center justify-center"
                    >
                      {social.icon}
                    </a>
                  </TooltipTrigger>
